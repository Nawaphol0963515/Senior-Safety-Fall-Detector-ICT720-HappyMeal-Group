...
// ============================================================
#define WIFI_SSID "TrueGigatexFiber_2.4G_7FA"    // change wifi here
#define WIFI_PASSWORD "NMUA6H46" // change wifi here
...
#define MQTT_TOPIC_FALL                                                        \
  "happymeal/fall" // topic Vinnie publishes fall alerts to
